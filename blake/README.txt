...
blake-alg-des.txt describes the variation of the BLAKE algorithm that is used in
this program

blake-alg-rat.txt explains the rationale for the changes relative to the
original series of algorithms
